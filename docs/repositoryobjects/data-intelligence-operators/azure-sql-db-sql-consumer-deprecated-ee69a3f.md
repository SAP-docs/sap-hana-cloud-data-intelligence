<!-- loioee69a3f7603747d09fbdaa43549647c7 -->

# Azure SQL DB SQL Consumer \(Deprecated\)
...
<a name="loioee69a3f7603747d09fbdaa43549647c7__section_sq1_nf3_vdb"/>
...
Mandatory. SQL statement that is used to read from the source. The syntax depends on the underlying source.
...
Optional. Partitioning used to enable data reading in parallel. In this case, the producer must be inside a group with multiplicity equal to the number of partitions \(**only** the producer, for example, Flowagent File Producer\).
...
Optional. For more information, see [Partitioning](partitioning-86085d9.md).
...
Optional. Session parameters that affect the connection with the source.
...
Optional. The number of rows that will be fetched from the source in each request. For wide tables, smaller values are better. For tables with fewer columns, larger values are better.
...
<a name="loioee69a3f7603747d09fbdaa43549647c7__section_knq_5f3_vdb"/>
...
<a name="loioee69a3f7603747d09fbdaa43549647c7__section_swc_cg3_vdb"/>
