<!-- loio9ed0ea4bc37f4be590c3695e30907e39 -->

# Oracle SQL Consumer \(Deprecated\)
...
<a name="loio9ed0ea4bc37f4be590c3695e30907e39__section_sq1_nf3_vdb"/>
...
Use the SQL editor to enter the SQL statement.
...
Indicates the number of rows that are fetched from the source in each request. For wide tables, smaller values are better. For tables with fewer columns, larger values are better.
...
<a name="loio9ed0ea4bc37f4be590c3695e30907e39__section_knq_5f3_vdb"/>
...
<a name="loio9ed0ea4bc37f4be590c3695e30907e39__section_swc_cg3_vdb"/>
